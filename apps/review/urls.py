...
urlpatterns = [
    ...
    path('review/papers/<str:paper_id>/questions/', views.question_list, name='question-list'),
    path('review/questions/<str:question_id>/', views.question_detail, name='question-detail'),
    path('review/questions/<str:question_id>/update/', views.question_update, name='question-update'),
    path('review/questions/<str:question_id>/confirm/', views.question_confirm, name='question-confirm'),
    path('review/questions/<str:question_id>/reject/', views.question_reject, name='question-reject'),
    ...
    path('review/question/<str:question_id>/ai-confirm/<str:mode>/', views.ai_confirm_answer, name='ai-confirm-answer'),
    path('review/question/<str:question_id>/ai-answer/<str:mode>/', views.ai_update_answer, name='ai-update-answer'),
    path('review/question/<str:question_id>/ai-knowledge/', views.ai_update_knowledge, name='ai-update-knowledge'),
    path('review/question/<str:question_id>/ai-status/', views.ai_question_status, name='ai-question-status'),
